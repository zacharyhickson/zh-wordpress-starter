<?php
/**
 * zh-starter-theme Theme Customizer
 *
...
function theme_slug_customize_preview_js() {
	wp_enqueue_script( 'theme_slug_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
